class ApiConfig{
  static String BASE_URL = 'https://frozen-savannah-16893.herokuapp.com/';
  static String PERSON_DETAILS_POST = 'matrimonial/PersonDetails';
  static String QUALIFICATION_DETAILS_POST = 'matrimonial/QualificationDetails';
  ...
  static String PROPERTIES_DETAILS_GET ='matrimonial/getData/PropertyDetails/';
  static String BUSINESS_DETAILS_GET ='matrimonial/getData/BusinessDetails/';
  static String IELTS_DETAILS_GET ='matrimonial/getData/IeltsDetails/';
  static String ABROAD_DETAILS_GET ='matrimonial/getData/AbroadDetails/';
  static String PARTNER_DETAILS_GET ='matrimonial/getData/PartnerDetails/';
  static String MARRIGEINTEREST_DETAILS_GET ='matrimonial/getData/InterestedDetails/';
}
